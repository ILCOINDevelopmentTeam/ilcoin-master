...
unlocked to sign the Ilcoin-Qt.app bundle.
...
allowing somebody to distribute a Ilcoin-Qt.app or ilcoin-qt-setup.exe with a valid
...
that the ilcoin-qt.exe file inside the installer had not been tampered with.
