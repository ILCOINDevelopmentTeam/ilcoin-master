...
static const unsigned int DEFAULT_BANSCORE_THRESHOLD = 100000;
...
typedef boost::unordered_map<uint256, CMiniBlockIndex*, BlockHasher> MiniBlockMap;
extern BlockMap mapBlockIndex;
extern MiniBlockMap mapMiniBlockIndex;
...
extern CMiniBlockIndex *pindexMiniBestHeader;
...
bool ProcessNewBlockHeaders(const std::vector<CBlockHeader>& block, CValidationState& state, const CChainParams& chainparams, const CMiniBlockIndex** ppindex=NULL);
...
int LoadExternalBlockFile(const CChainParams& chainparams, FILE* fileIn, CDiskBlockPos *dbp = NULL, int totalLoaded = 0);
...
extern CMiniChain miniChainActive;
