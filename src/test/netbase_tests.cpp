...
{
    BOOST_CHECK(TestSplitHost("www.ilcoin.org", "www.ilcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.ilcoin.org]", "www.ilcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.ilcoin.org:80", "www.ilcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.ilcoin.org]:80", "www.ilcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:11053", "127.0.0.1", 11053));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:11053", "127.0.0.1", 11053));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:11053", "::ffff:127.0.0.1", 11053));
    BOOST_CHECK(TestSplitHost("[::]:11053", "::", 11053));
    BOOST_CHECK(TestSplitHost("::11053", "::11053", -1));
    BOOST_CHECK(TestSplitHost(":11053", "", 11053));
    BOOST_CHECK(TestSplitHost("[]:11053", "", 11053));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:11053", "127.0.0.1:11053"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:11053", "[::]:11053"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
