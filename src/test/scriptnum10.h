...
#ifndef ILCOIN_TEST_SCRIPTNUM10_H
#define ILCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Ilcoin Core 0.10.0, for cross-comparison.
 */
public:
