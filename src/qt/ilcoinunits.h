...
#ifndef ILCOIN_QT_ILCOINUNITS_H
#define ILCOIN_QT_ILCOINUNITS_H
...
/** Ilcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class IlcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit IlcoinUnits(QObject *parent);

    /** Ilcoin units.
      @note Source: https://en.ilcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        ILC,
...
typedef IlcoinUnits::Unit IlcoinUnit;

#endif // ILCOIN_QT_ILCOINUNITS_H
