...
This document provides guidelines for internationalization of the Ilcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ilcoin_en.ts` remains unchanged.
