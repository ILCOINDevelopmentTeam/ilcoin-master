Ilcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/ilcoin/files/Ilcoin/ilcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Ilcoin
...
New/changed settings (command-line or ilcoin.conf file)
--------------------------------------------------------
