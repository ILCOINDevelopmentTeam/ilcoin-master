Ilcoin Core version 0.13.2 is now available from:

  <https://ilcoin.org/bin/ilcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update ilcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow ilcoin-tx to create v2 transactions (ILCdrak)
