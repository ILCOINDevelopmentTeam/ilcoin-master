Ilcoin Core version 0.10.4 is now available from:

  <https://ilcoin.org/bin/ilcoin-core-0.10.4/>
...
- #6953 `43c2789` Split ilcoin-tx into its own package
- #6953 `dfe0d4d` Include ilcoin-tx binary on Debian/Ubuntu
