Ilcoin Core version 0.9.4 is now available from:

  https://ilcoin.org/bin/0.9.4/
...
this update is incompatible with the Ilcoin system and could lead to consensus
forks.

Ilcoin Core released binaries from https://ilcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~ilcoin/+archive/ubuntu/ilcoin
- A third-party or self-compiled Ilcoin Core

upgrade to Ilcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
