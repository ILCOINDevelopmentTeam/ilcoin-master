...
class WalletTest (IlcoinTestFramework):
    ...
    def run_test (self):
        ...
        # node0 should end up with 100 ILC in block rewards plus fees, but
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/ilcoin/ilcoin/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
