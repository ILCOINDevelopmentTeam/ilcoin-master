...
class RawTransactionsTest(IlcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid ilcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid ilcoin address" in e.error['message'])
