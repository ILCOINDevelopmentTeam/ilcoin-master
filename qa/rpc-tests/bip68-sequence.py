...
class BIP68Test(IlcoinTestFramework):
    def __init__(self):
        super().__init__()
        self.num_nodes = 2
    ...
    def run_test(self):
        ...
        print("Note that with current versions of ilcoin software, nVersion=2 transactions are always standard (independent of BIP68 activation status).")
